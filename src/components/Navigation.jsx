      ...
      >
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex gap-7 pointer-events-auto items-center">
            ...
            <Link to="/crop-analysis" className="text-[11px] tracking-[2px] uppercase text-[rgba(215,230,190,0.55)] hover:text-accent font-medium transition-colors">
              {t('navigation.cropAnalysis')}
            </Link>
            <Link to="/yield" className="text-[11px] tracking-[2px] uppercase text-[rgba(215,230,190,0.55)] hover:text-accent font-medium transition-colors">
              {t('navigation.yieldForecast')}
            </Link>
            {currentUser ? (
            ...
            <div className="relative inline-flex items-center gap-2 pointer-events-auto ml-2">
              <label htmlFor="language-select" className="text-[10px] uppercase tracking-[2px] text-[rgba(215,230,190,0.55)]">{t('navigation.languageLabel')}</label>
              <select
                id="language-select"
                value={language}
            ...
            <div className="relative inline-block pointer-events-auto ml-2">
              ...
              {isOpen && (
                <div className="absolute top-[40px] right-0 bg-[rgba(10,18,10,0.85)] backdrop-blur-md border border-[rgba(140,180,120,0.15)] rounded-lg min-w-[200px] flex flex-col py-2 z-[1000] shadow-2xl animate-fade-in">
                  <Link to="/dashboard" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] border-b border-[rgba(140,180,120,0.05)] transition-colors">{t('navigation.dashboard')}</Link>
                  <Link to="/assistant" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] border-b border-[rgba(140,180,120,0.05)] transition-colors">{t('navigation.assistant')}</Link>
                  <Link to="/disease" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] border-b border-[rgba(140,180,120,0.05)] transition-colors">{t('navigation.diseaseDetection')}</Link>
                  <Link to="/crop" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] border-b border-[rgba(140,180,120,0.05)] transition-colors">{t('navigation.cropRecommendation')}</Link>
                  <Link to="/crop-analysis" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] border-b border-[rgba(140,180,120,0.05)] transition-colors">{t('navigation.cropAnalysis')}</Link>
                  <Link to="/yield" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] border-b border-[rgba(140,180,120,0.05)] transition-colors">{t('navigation.yieldForecast')}</Link>
                  <Link to="/weather" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] border-b border-[rgba(140,180,120,0.05)] transition-colors">{t('navigation.weather')}</Link>
                  <Link to="/irrigation" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] border-b border-[rgba(140,180,120,0.05)] transition-colors">{t('navigation.irrigation')}</Link>
                  <Link to="/market" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] border-b border-[rgba(140,180,120,0.05)] transition-colors">{t('navigation.market')}</Link>
                  <Link to="/schemes" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] border-b border-[rgba(140,180,120,0.05)] transition-colors">{t('navigation.schemes')}</Link>
                  <Link to="/profile" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] border-b border-[rgba(140,180,120,0.05)] transition-colors">{t('navigation.profile')}</Link>
                  <Link to="/alerts" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] border-b border-[rgba(140,180,120,0.05)] transition-colors">{t('navigation.alerts')}</Link>
                  <Link to="/analytics" onClick={() => setIsOpen(false)} className="text-[rgba(215,230,190,0.7)] hover:text-accent hover:bg-[rgba(40,65,40,0.4)] px-5 py-2.5 text-[13px] tracking-[1px] transition-colors">{t('navigation.analytics')}</Link>
                </div>
              )}
            </div>
          </div>
